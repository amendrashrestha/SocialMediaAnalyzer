...
public class IOReadWrite {
    ...
    public void writeToFile(String fileName, String content) throws IOException{
         ...
         String completeFileNameNPath = IOProperties.INDIVIDUAL_USER_FILE_PATH +getUserFolderName + "\\" +fileName + IOProperties.USER_FILE_EXTENSION;
     ...
     */
     ...
     public String readTxtFileAsString(String basePath, String directoryName, String fileName, String extension) throws FileNotFoundException, IOException{
         ...
         return stringBuilder.substring(0, (stringBuilder.length() - (IOProperties.DATA_SEPERATOR).length())).toString();
     }
     ...
     public User convertTxtFileToUserObj(String basePath, String directoryName, String fileName, String extension) throws FileNotFoundException, IOException{
         ...
         for (int i = 0; i < temp.length; i++){
             ...
             String date = temp[i].substring(0, 10);
             if (date.matches("[0-9]{4}-[0-9]{2}-[0-9]{2}")){
                 posts.setDate(date);
                 posts.setContent(temp[i].substring(10, temp[i].length()));
                 postList.add(posts);
             }else{
                 continue;
             }
